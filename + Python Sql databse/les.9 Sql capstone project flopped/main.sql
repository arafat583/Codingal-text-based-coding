...
CREATE TABLE Orders (
 ...
 FOREIGN KEY Salesman_id REFERENCES Salesman(Saesman_id)
);
...
FROM Customer
JOIN Salesman ON Customer.Slesman_id = Salesman.Salesman_id;

SELECT Orders.ord_np, Customers.cust_name, Orders.customer_id, Orders.Salesman_id
FROM Orderds
JOIN Customer ON Orders.customer_id = Customer.customer_id 
JOIN Salesman ON Orders.Salesman_id = Salesman.Salesman)id 
